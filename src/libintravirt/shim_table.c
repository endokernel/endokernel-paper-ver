...
shim_fp shim_table[SYSCALLNR] = {
    ...
    (shim_fp)__shim_add_key,
    (shim_fp)__shim_request_key,
    (shim_fp)__shim_keyctl,
    ...
    (shim_fp)__shim_iv_domain_safe,
    (shim_fp)__shim_iv_domain_sand,
    (shim_fp)__shim_iv_domain_lib,
    (shim_fp)__shim_iv_change_mem_domain,
#ifdef TOORHC
    (shim_fp)__shim_endo_toorhc,
#else
    NULL,
#endif
    (shim_fp)__shim_iv_domain_temp,
    (shim_fp)__shim_iv_empty,
    (shim_fp)__shim_iv_force_getppid,
    // 341
    (shim_fp)__shim_iv_set_tdomain_info,
    (shim_fp)__shim_iv_set_tdomain_filter,
