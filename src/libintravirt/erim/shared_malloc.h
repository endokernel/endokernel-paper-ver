...
MALLOC_FAILURE_ACTION     default: sets errno to -1, or no-op on win32
...
#endif  /* HAVE_MREMAP */
#ifndef MALLOC_FAILURE_ACTION
#define MALLOC_FAILURE_ACTION  //errno = -1;
#endif  /* MALLOC_FAILURE_ACTION */
#ifndef HAVE_MORECORE
#if ONLY_MSPACES
#define HAVE_MORECORE 0
...
/*
  ...
  null if no space is available, in which case errno is set to -1
  on ANSI C systems.
