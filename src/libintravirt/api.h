...
int sprintputch(void* f, int ch, void* b);
int fputch(void* f, int ch, void* b);

void vfprintfmt_sprintputch (void * f, void * putdat,
                 const char * fmt, va_list ap) __attribute__((format(printf, 3, 0)));

void vfprintfmt_fputch (void * f, void * putdat,
                 const char * fmt, va_list ap) __attribute__((format(printf, 3, 0)));
