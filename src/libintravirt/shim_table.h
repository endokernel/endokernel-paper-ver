...
//long __shim_rseq(long, long, long, long, long, long);
...
/* libiso */
long __shim_iv_domain_safe(long);
long __shim_iv_domain_temp(long);
long __shim_iv_domain_sand(long);
long __shim_iv_domain_lib(long, long);
long __shim_iv_change_mem_domain(long, long, long);
long __shim_iv_empty();
long __shim_iv_force_getppid();
#ifdef TOORHC
long __shim_endo_toorhc(long, long);
#endif
long __shim_iv_set_tdomain_info(long, long, long, long);
long __shim_iv_set_tdomain_filter(long);
...
int shim_do_iv_domain_safe(const char* buf);
int shim_do_iv_domain_temp(const char* buf);
int shim_do_iv_domain_sand(const char* buf);
int shim_do_iv_domain_lib(const char* elf, int* domain_id);
int shim_do_iv_empty();
int shim_do_iv_force_getppid();
...
int shim_rt_sigaction(int signum, const struct __kernel_sigaction* act,
                      struct __kernel_sigaction* oldact, size_t sigsetsize);
int shim_rt_sigprocmask(int how, const __sigset_t* set, __sigset_t* oldset, size_t sigsetsize);
unsigned long shim_rt_sigreturn(int __unused);
...
int shim_rt_sigsuspend(const __sigset_t* mask, size_t sigsetsize);
...
int shim_iv_domain_safe(const char* buf);
int shim_iv_domain_temp(const char* buf);
int shim_iv_domain_sand(const char* buf);
int shim_iv_domain_lib(const char* elf, int* domain_id);
int shim_iv_empty();
int shim_iv_force_getppid();
int shim_iv_set_tdomain_info(void* ptr, void** funclist, void* start, void* end);
int shim_iv_set_tdomain_filter(int id);
